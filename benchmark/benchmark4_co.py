...
file_name = 'benchmark/benchmark4_im1.data'
...
plt.savefig(f'benchmark/benchmark4t_nim{num_images}.png', dpi=300)  # Save the plot as an image
...
plt.savefig(f'benchmark/benchmark4p_nim{num_images}.png', dpi=300)  # Save the plot as an image
