...
data = []
with open('benchmark/benchmark3_im1.data', 'r') as file:
    for _ in range(3):
...
plt.tight_layout()
plt.savefig(f'benchmark/benchmark3a_nim{number_images}.png', dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig(f'benchmark/benchmark3b_nim{number_images}.png', dpi=300)
plt.show()
